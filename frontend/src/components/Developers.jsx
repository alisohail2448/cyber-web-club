...
const Developers = () => {
  return (
    <div className='w-full h-[150px]'>
        ...
        <div className="names flex justify-center items-center gap-5 mt-8">
        ...
        <p className='text-[#40f59d] text-center text-sm mt-[30px]'>Cyber Web Club - 2023 &copy; Copyright</p>
    </div>
  )
}
